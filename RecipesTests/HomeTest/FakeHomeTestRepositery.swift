...
class FakeHomeRepositery: HomeRepsiteryProtocol {
    ...
    func getRecipes(complation: @escaping ([RecipesModelElement]) -> Void) {
        ...
        case .success:
            complation([RecipesModelElement(id: "12", fats: "3", name: "Meat", time: "11:23", image: "Ss", weeks: [""], carbos: "24", fibers: "rdd", rating: 0.5, country: "EGY", ratings: 90, calories: "100", headline: "MILK", keywords: ["sss"], products: ["Sss"], proteins: "13", favorites: 09, difficulty: 10, description: "Very Goo Meat", highlighted: true, ingredients: ["sss"], deliverableIngredients: ["dd"])])
        case .fail:
            complation([])
